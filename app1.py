...
def user_inputs():
    ...
    Hotel = st.selectbox("Select hotel", ["Tatva", "Thanda Mamla", "Mayur", "Amrai", "Hotel Somton Montel", "Taj Hotel"])
    location = st.selectbox(
        "Select the location", ["Pune", "Mumbai", "Hyderabad", "Nagpur", "South India"]
    )
